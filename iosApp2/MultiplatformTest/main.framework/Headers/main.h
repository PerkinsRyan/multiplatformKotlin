...
- (instancetype)initWithParkRepository:(MainParkRepository *)parkRepository __attribute__((swift_name("init(parkRepository:)"))) __attribute__((objc_designated_initializer));
- (void)bindViewMainView:(id<MainMainView>)mainView __attribute__((swift_name("bindView(mainView:)")));
- (void)filterParksFilter:(NSString *)filter __attribute__((swift_name("filterParks(filter:)")));
@property (readonly) MainParkRepository *parkRepository;
@end;

__attribute__((swift_name("MainView")))
@protocol MainMainView
@required
- (void)showParksParks:(NSArray<MainPark *> *)parks __attribute__((swift_name("showParks(parks:)")));
- (void)showVisitedCountCount:(int32_t)count __attribute__((swift_name("showVisitedCount(count:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Park")))
@interface MainPark : KotlinBase
- (instancetype)initWithName:(NSString *)name visited:(BOOL)visited __attribute__((swift_name("init(name:visited:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (BOOL)component2 __attribute__((swift_name("component2()")));
- (MainPark *)doCopyName:(NSString *)name visited:(BOOL)visited __attribute__((swift_name("doCopy(name:visited:)")));
@property (readonly) NSString *name;
@property (readonly) BOOL visited;
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Park.Companion")))
@interface MainParkCompanion : KotlinBase
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Park.$serializer")))
@interface MainPark$serializer : KotlinBase <MainKotlinx_serialization_runtime_nativeGeneratedSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)$serializer __attribute__((swift_name("init()")));
- (MainPark *)deserializeDecoder:(id<MainKotlinx_serialization_runtime_nativeDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (MainPark *)patchDecoder:(id<MainKotlinx_serialization_runtime_nativeDecoder>)decoder old:(MainPark *)old __attribute__((swift_name("patch(decoder:old:)")));
- (void)serializeEncoder:(id<MainKotlinx_serialization_runtime_nativeEncoder>)encoder obj:(MainPark *)obj __attribute__((swift_name("serialize(encoder:obj:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ParkRepository")))
@interface MainParkRepository : KotlinBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)getAllParksCallback:(MainKotlinUnit *(^)(NSArray<MainPark *> *))callback __attribute__((swift_name("getAllParks(callback:)")));
- (void)getParksFilter:(NSString *)filter callback:(MainKotlinUnit *(^)(NSArray<MainPark *> *))callback __attribute__((swift_name("getParks(filter:callback:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ParksApi")))
@interface MainParksApi : KotlinBase
